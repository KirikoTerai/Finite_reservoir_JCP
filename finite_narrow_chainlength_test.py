...
def run_finite(t, left_electron, right_electron):
    ...
    def makeRateMatrix():
        ...
        for initial in range(net.adj_num_state):
            for final in range(net.adj_num_state):
                if initial != final:
                    # Site - site
                    for donor_id in range(site_A_id, site_B_id):
                        for acceptor_id in range(site_A_id+1, site_B_id+1):
                            if acceptor_id - donor_id == 1:   # Nearest-neighbor hopping
                                if net.idx2state(net.allow[initial])[donor_id]-net.idx2state(net.allow[final])[donor_id]==1:
                                    if net.idx2state(net.allow[final])[acceptor_id]-net.idx2state(net.allow[initial])[acceptor_id]==1:
                                        # initial, final state found! check other electron conservation
                                        I = np.delete(net.idx2state(net.allow[initial]), [donor_id, acceptor_id])     # Do not allow changes other than cof_i and cof_f we have searched for
                                        J = np.delete(net.idx2state(net.allow[final]), [donor_id, acceptor_id])     # Deleting the cof_i and cof_f that is already checked to be correct
                                        if np.array_equal(I, J):   # Checking that sites other than cof_i and cof_f hasn't changed
                                            deltaG = 0
                                            # print(net.idx2state(net.allow[initial]), net.idx2state(net.allow[final]))
    ...
    initial_state = [0]*net.num_site
    initial_state[0] = left_electron
    initial_state[-1] = right_electron
    ...
    pop_A1 = net.population(pop_MEK, A1, 1)
    pop_A2 = net.population(pop_MEK, A2, 1)
    ...
    return pop_A, pop_A1, pop_A2, pop_B, flux_left, flux_right, pop_MEK, pop_Left, pop_Right
...
for t in time:
    ## 010 ##
    pop_A_010, pop_A1_010, pop_A2_010, pop_B_010, flux_left_010, flux_right_010, pop_MEK_010, pop_Left_010, pop_Right_010 = run_finite(t, 0, 10)
    ...
    pop_A1_t_010.append(pop_A1_010)
    pop_A2_t_010.append(pop_A2_010)
    ## 28 ##
    pop_A_28, pop_A1_28, pop_A2_28, pop_B_28, flux_left_28, flux_right_28, pop_MEK_28, pop_Left_28, pop_Right_28 = run_finite(t, 2, 8)
    ...
    pop_A1_t_28.append(pop_A1_28)
    pop_A2_t_28.append(pop_A2_28)
    ## 46 ##
    pop_A_46, pop_A1_46, pop_A2_46, pop_B_46, flux_left_46, flux_right_46, pop_MEK_46, pop_Left_46, pop_Right_46 = run_finite(t, 4, 6)
    ...
    pop_A1_t_46.append(pop_A1_46)
    pop_A2_t_46.append(pop_A2_46)
    ## 55 ##
    pop_A_55, pop_A1_55, pop_A2_55, pop_B_55, flux_left_55, flux_right_55, pop_MEK_55, pop_Left_55, pop_Right_55 = run_finite(t, 5, 5)
    ...
    pop_A1_t_55.append(pop_A1_55)
    pop_A2_t_55.append(pop_A2_55)
    ## 64 ##
    pop_A_64, pop_A1_64, pop_A2_64, pop_B_64, flux_left_64, flux_right_64, pop_MEK_64, pop_Left_64, pop_Right_64 = run_finite(t, 6, 4)
    ...
    pop_A1_t_64.append(pop_A1_64)
    pop_A2_t_64.append(pop_A2_64)
    ## 82 ##
    pop_A_82, pop_A1_82, pop_A2_82, pop_B_82, flux_left_82, flux_right_82, pop_MEK_82, pop_Left_82, pop_Right_82 = run_finite(t, 8, 2)
    ...
    pop_A1_t_82.append(pop_A1_82)
    pop_A2_t_82.append(pop_A2_82)
    ## 100 ##
    pop_A_100, pop_A1_100, pop_A2_100, pop_B_100, flux_left_100, flux_right_100, pop_MEK_100, pop_Left_100, pop_Right_100 = run_finite(t, 10, 0)
    ...
    pop_A1_t_100.append(pop_A1_100)
    pop_A2_t_100.append(pop_A2_100)
...
plt.plot(time, pop_A1_t_010, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_010, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig010.savefig("finite_pop_010_4sites.pdf")

fig28 = plt.figure()
plt.plot(time, pop_A_t_28, label="p$_{A}$", color="black")
plt.plot(time, pop_A1_t_28, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_28, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig28.savefig("finite_pop_28_4sites.pdf")

fig46 = plt.figure()
plt.plot(time, pop_A_t_46, label="p$_{A}$", color="black")
plt.plot(time, pop_A1_t_46, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_46, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig46.savefig("finite_pop_46_4sites.pdf")

fig55 = plt.figure()
plt.plot(time, pop_A_t_55, label="p$_{A}$", color="black")
plt.plot(time, pop_A1_t_55, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_55, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig55.savefig("finite_pop_55_4sites.pdf")

fig64 = plt.figure()
plt.plot(time, pop_A_t_64, label="p$_{A}$", color="black")
plt.plot(time, pop_A1_t_64, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_64, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig64.savefig("finite_pop_64_4sites.pdf")

fig82 = plt.figure()
plt.plot(time, pop_A_t_82, label="p$_{A}$", color="black")
plt.plot(time, pop_A1_t_82, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_82, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig82.savefig("finite_pop_82_4sites.pdf")

fig100 = plt.figure()
plt.plot(time, pop_A_t_100, label="p$_{A}$", color="black")
plt.plot(time, pop_A1_t_100, label="p$_{1}$", color="black")
plt.plot(time, pop_A2_t_100, label="p$_{2}$", color="blue")
...
plt.tight_layout()
# plt.show()
fig100.savefig("finite_pop_100_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig010f.savefig("finite_flux_010_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig28f.savefig("finite_flux_28_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig46f.savefig("finite_flux_46_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig55f.savefig("finite_flux_55_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig64f.savefig("finite_flux_64_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig82f.savefig("finite_flux_82_4sites.pdf")
...
#plt.legend()
plt.tight_layout()
fig100f.savefig("finite_flux_100_4sites.pdf")
